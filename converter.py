import numpy as np
from constant import s_box, roundConstant, encryptMDS, mc2, mc3
from constant import invs_box, decryptMDS, mc9, mc11, mc13, mc14
# aes512
from constant import roundConstant_8, encryptMDS_8, decryptMDS_8
...
def gf_mult(scalar, val):
    if scalar == 1:
        return val
        
    msb = (val & 0b11110000) >> 4
    lsb = val & 0b00001111
    ...
    raise ValueError("Invalid MixColumns scalar!")